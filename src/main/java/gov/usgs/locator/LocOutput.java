...
public class LocOutput extends LocationResult {
  ...
  public void addErrors(double timeError, double latError, double lonError, 
    ...
    getErrorEllipse().setE0Error(ellipsoid[0].getSemiLen());
    getErrorEllipse().setE0Azimuth(ellipsoid[0].getAzimuth());
    getErrorEllipse().setE0Dip(ellipsoid[0].getPlunge());
    getErrorEllipse().setE1Error(ellipsoid[1].getSemiLen());
    getErrorEllipse().setE1Azimuth(ellipsoid[1].getAzimuth());
    getErrorEllipse().setE1Dip(ellipsoid[1].getPlunge());
    getErrorEllipse().setE2Error(ellipsoid[2].getSemiLen());
    getErrorEllipse().setE2Azimuth(ellipsoid[2].getAzimuth());
    getErrorEllipse().setE2Dip(ellipsoid[2].getPlunge());
