...
/**
 * The LocOutput class stores the outputs from an event relocation.  This class 
 * is designed to contain all parameters resulting from a Locator pass.  An 
 * object of this class should be handed to the output routines to be returned 
 * to the caller.
 * 
...
public class LocOutput extends LocationResult {
  ...
  /**
   * The LocOutput constructor. This constructor populates the LocOutput class
   * with the givin parameters that are produced by an event relocation.
   * 
   * @param originTime A double containing the source origin time of this location in 
   *                   location in milliseconds.
   * @param sourceLatitude A Double containing the geographic source latitude of 
   *                       this location in degrees.
   * @param sourceLongitude A double containing the geographic source longitude 
   *                        of this location in degrees.
   * @param sourceDepth A double containing the source depth of this location 
   *                    in kilometers.
   * @param numStationsAssociated An int containing the number of stations 
   *                              associated with this location.
   * @param numPhasesAssociated An int containing the number of phases 
   *                            associated with this location.
   * @param numStationsUsed An int containing the number of stations used in 
   *                        this location.
   * @param numPhasesUsed An int containing the number of picks used in 
   *                      this location.
   * @param azimuthGap A double containing the standard azimuthal gap in degrees
   *                   for this location.
   * @param azimuthalGapLEst A double containing the Robust (L-estimator) 
   *                         azimuthal gap in degrees for this location.
   * @param minStationDistance A double containing the minimum source-receiver 
   *                           distance in degrees for this location.
   * @param qualityFlags A String containing the summary event quality flags.
   */
  public LocOutput(long originTime, double sourceLatitude, 
      double sourceLongitude, double sourceDepth, int numStationsAssociated, 
      int numPhasesAssociated, int numStationsUsed, int numPhasesUsed, 
      double azimuthGap, double azimuthalGapLEst, double minStationDistance, 
      String qualityFlags) {
  ...
  /**
   * This function sets the following error parameters which are produced by an 
   * event relocation.
   * 
   * @param timeStandardError A double containing the standard error of the 
   *                          origin time in seconds.
   * @param latitudeStandardError A double containing the standard error of the 
   *                              latitude in kilometers.
   * @param longitudeStandardError A double containing the standard error of the 
   *                               latitude in kilometers.
   * @param depthStandardError A double containing the standard error of the 
   *                           depth in kilometers.
   * @param residualsStandardError A double containing the standard error of the 
   *                               residuals in seconds.
   * @param maxHorizontalError A double containing the maximum horizontal 
   *                           projection of the error ellipsoid in kilometers.
   * @param maxVerticalError A double containing the maximum vertical projection 
   ...
   * @param bayesianDepthSpread A double containing the Bayesian depth spread in 
   *                            kilometers.
   ...
   *                        code. 
   */
  public void addErrors(double timeStandardError, double latitudeStandardError, 
      double longitudeStandardError, double depthStandardError, 
  ...
  /**
   * This function adds a pick to LocOutput, using the following parameters 
   * which are produced for each located pick.
   * 
   * @param source A String containing the source of the database pick ID
   * @param authType An AuthorType object containing the type (e.g., human or 
   *                 auto) of the original phase identification
   ...
   * @param stationLongitude A double containing the station longitude in 
   *                         degrees
   ...
   * @param azimuth A double containing the receiver azimuth (clockwise from 
   *                north) in degrees.
   ...
   * @param pickAffinity A double containing the pick affinity, the higher the 
   *                     affinity, the harder it is to re-identify a pick.  By 
   *                     default, the affinity for the four author types would 
   *                     be 1.0, 1.0, 1.5, and 3.0 respectively.
   * @param pickQuality A double containing the pick standard deviation in 
   *                    seconds.
   */
   ...
   * @param filePath A String containing the file name and path to write the 
   *                 hydra output to.
  ...
  /**
   * This function converts the provided pick into a Bulletin Hydra style 
   * output pick line.
   * @param pick A gov.usgs.processingformats.Pick containing the pick to write
   * @return Returns a string containing the Bulletin Hydra style output pick 
   *         line.
   */
