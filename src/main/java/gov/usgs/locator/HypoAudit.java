...
public class HypoAudit {
  ...
  /** 
   * A double containing the origin time in seconds since the epoch for this 
	 * audit record.
   */
  private double originTime; 
  
  /** 
   * A double containing the geographic latitude in degrees for this audit 
   * record.
   */
  private double latitude; 

  /**
   * A double containing the geographic longitude in degrees for this audit 
   * record.
   */
  ...
  /**
   * A double containing the hypocentral change in kilometers for this audit 
   * record.
   */
  private double hypocentralChange;

  /**
   * A double containing the epicentral change in kilometers for this audit 
   * record.
   */
