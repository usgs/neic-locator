...
public class ZoneStat implements Serializable {
   ...
   * 
   * @param meanFreeDepth A double holding the average historical free depth in 
   *                      kilometers
   * @param miniumFreeDepth A double holding the shallowest historical free 
   *                        depth in kilometers
   * @param maximumFreeDepth A double containing the deepest historical free 
   *                         depth in kilometers
   */
  public ZoneStat(double meanFreeDepth, double miniumFreeDepth, 
      double maximumFreeDepth) {
