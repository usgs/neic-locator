...
public class EllipAxis implements Comparable<EllipAxis> {
  ...
  /** 
   * A double containing the azimuth of the axis in degrees (clockwise from 
   * north).
   */
  private double azimuth;

  /** 
   * A double containing the plunge of the axis in degrees (down from the 
   * horizontal).
   */
   ...
   * 
   * @return A double containing the tangential projection of this axis in 
   *         kilometers
   */
   ...
   * 
   * @return A double containing the vertical projection of this axis in 
   *         kilometers
   */
  ...
  /**
   * Function to return the azimuth of the axis in degrees (clockwise from 
   * north).
   **/ 
  ...
  /**
   * Function to return the plunge of the axis in degrees (down from the 
   * horizontal).
   **/ 
