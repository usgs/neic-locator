...
/**
 * Station identifier (expanded station code). This designation has expanded even further now, but
 * this was complete during the Hydra design.
 *
 * @author Ray Buland
 */
public class StationID implements Comparable<StationID> {
   ...
   * @return +1, 0, or -1 if this StationID is alphabetically later, the same or earlier
   */
  @Override
