...
/**
 * The RSumEstResult class saves the results of one pass through the rank-sum estimator algorithm.
 *
 * @author Ray Buland
 */
public class RSumEstResult {
  ...
  /**
   * The RSumEstResult constructor. Initializes the class to a set of results from the rank-sum
   * estimator algorithm.
   *
   ...
   */
  public RSumEstResult(
      double stepLength, double medianResidual, double residualSpread, double dispersion) {
