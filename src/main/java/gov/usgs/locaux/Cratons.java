...
/**
 * The Cratons class keeps track of the geographic boundaries of continental cratons. Both travel
 * times and magnitudes are sensitive to the age and stability of the crust. For example, in
 * cratons, Pg and Pb are distinct phases and mbLg is a preferred magnitude. In active areas, Pb is
 * an extension of Pg instead of a distinct phase and Ml is preferred.
 *
 * @author Ray Buland
 */
public class Cratons implements Serializable {
   ...
   *     boundary polygon of the craton
   */
  public void add(String name, double[] latitudePoints, double[] longitudePoints) {
   ...
   *
   * @param latitude A double containing the geographical epicenter latitude in degrees
   * @param longitude A double containing the geographical epicenter longitude in degrees
