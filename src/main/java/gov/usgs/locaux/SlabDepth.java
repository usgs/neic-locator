...
/**
 * Store slab depth information.  Note that this is just a convenience for 
 * processing the slab ASCII data, but is used for the final storage as 
 * having a latitude and longitude for every point is unnecessary.
 * 
 * @author Ray Buland
 *
 */
public class SlabDepth implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
	 * For slab visualization (option 1), the three depths correspond to the 
	 * slab surface depth, the approximate earthquake depth, and the slab 
	 * bottom depth.  For earthquake location (option 2), the three depths 
	 * correspond to the shallow error bar, the earthquake depth, and the 
	 * deeper error bar.
	 */
	double[] eqDepth;
	...
	public String toString() {
		return String.format("%6.2f < %6.2f < %6.2f", eqDepth[0], eqDepth[1], 
				eqDepth[2]);
	}
}
