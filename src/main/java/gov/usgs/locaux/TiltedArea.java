...
public class TiltedArea {
  ...
  /**
   * Add a point to the tilted slab pool. Note that all tilted slab samples go into the pool for
   * later sorting.
   *
  ...
  /**
   * Create a grid on half degree intervals that spans the range and domain of the tilted slab
  ...
  /**
   * Fill the grid by running through all the points in the pool and assigning each one to a grid
   * point.
   */
