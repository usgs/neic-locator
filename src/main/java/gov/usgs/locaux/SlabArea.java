...
public class SlabArea implements Serializable {
  ...
  /**
   * Add a new slab latitude row. After squeezing the row will be comprised of one or more segments.
   *
  ...
  /**
   * Get the slab depth triplet at the desired point. Note that the slab areas have been split up so
   * that no more than one depth value should be possible from each area.
   *
   * @param lat Geographic colatitude in degrees (0-180 degrees)
   * @param lon Geographic longitude in degrees (0-360 degrees)
  ...
  /**
   * We've found the vectors surrounding the desired geographic point, but because we've loosened
  ...
  /**
   * Interpolate the slab depth triplet. The four input vectors should be the depth points
   * surrounding the desired point. For each point, there is a three vector for the spatial position
   * (i.e., longitude, latitude, and depth). For each depth, there is a 3-vector for the depth
   * triplet (i.e., minimum depth, earthquake depth, and maximum depth).
   *
   * @param v0 Vector describing the triplet for the longitude points surrounding the desired point
   *     in the first latitude row
   * @param v1 Vector describing the triplet for the longitude points surrounding the desired point
   *     in the second latitude row
  ...
  /**
   * In order to jump to the right latitude row, the latitudes need to be complete. If there are
